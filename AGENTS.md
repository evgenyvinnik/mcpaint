...
Natural language canvas control via Codex API with SSE streaming. The AI executes 50+ drawing commands covering all Paint functionality.

**Architecture**:
- `api/ai/draw.ts` - Vercel Edge Function proxying Codex API with tool calling
